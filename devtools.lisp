...
(unimplements)
(SETFORMS CLIENT-IP KILL-THREAD SETTER ALREF READLINE EXPAND= CCC SREF SINCE
 EXCEPTION SPLITN THROW SAVE-TABLE REP READ-TABLE SAFE-LOAD-TABLE LATIN1-HACK
 DECLARE CURRENT-GC-MILLISECONDS DEFSET SSEXPAND SOCKET-ACCEPT WRITE-SPACED
 PIPE-FROM WRITE-TABLE LOAD-TABLES BREAK-THREAD EXPAND=LIST ENSURE-DIR READB
 PPR-PROGN LOAD-TABLE FORCE-CLOSE PROTECT PPR SP SOCKET SWAP OPEN-SOCKET
 QUASIQUOTE ANNOTATE PPREST DETAILS PPR-CALL FILL-TABLE DEFAULT TD CACHE)
379
49
