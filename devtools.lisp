...
(unimplements)
(SETFORMS CLIENT-IP KILL-THREAD SETTER ALREF EXPAND= CCC SREF SINCE EXCEPTION
 THROW REP LATIN1-HACK DECLARE CURRENT-GC-MILLISECONDS DEFSET SSEXPAND
 SOCKET-ACCEPT WRITE-SPACED BREAK-THREAD EXPAND=LIST READB PPR-PROGN
 FORCE-CLOSE PROTECT PPR SP SOCKET SWAP OPEN-SOCKET QUASIQUOTE ANNOTATE PPREST
 DETAILS PPR-CALL DEFAULT CACHE)
377
37
