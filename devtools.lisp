...
(unimplements)
(SETTER EXPAND=LIST CACHE PPR-PROGN ALREF SETFORMS PPREST PPR CLIENT-IP
 PPR-CALL THROW SP SOCKET-ACCEPT QUASIQUOTE SOCKET WRITE-SPACED SSEXPAND
 DEFAULT ANNOTATE LATIN1-HACK OPEN-SOCKET SINCE SREF SWAP DECLARE CCC EXPAND=
 EXCEPTION FORCE-CLOSE DEFSET)
377
30
